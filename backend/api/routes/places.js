...
router.get("/", authMiddleware, checkRevoked, async (req, res) => {
  try {
...
// GET /api/places/:id
router.get("/:id", authMiddleware, checkRevoked, async (req, res) => {
  try {
...
// POST /api/places
router.post("/", authMiddleware, checkRevoked, async (req, res) => {
  try {
...
// PATCH /api/places/:id
router.patch("/:id", authMiddleware, checkRevoked, async (req, res) => {
  try {
    const id = parseInt(req.params.id, 10);
...
router.delete("/:id", authMiddleware, checkRevoked, async (req, res) => {
  try {
    const id = parseInt(req.params.id, 10);
